defmodule EcritsWeb.Locale do
  ...
  * In `:test`, `config/test.exs` overrides it back to `"en"` so the
  ...
  Brand wordmarks ("ecrits"), regulator names ("법제처"), and
  ...
  def call(conn, _opts) do
    Gettext.put_locale(EcritsWeb.Gettext, ui_locale())
    conn
  end
  ...
  """
  def ui_locale do
    Application.get_env(:ecrits, :ui_locale, "en")
  end
