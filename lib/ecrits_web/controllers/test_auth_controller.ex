if Application.compile_env(:ecrits, :test_auth, false) do
  defmodule EcritsWeb.TestAuthController do
    ...
    alias Ecrits.{Accounts, PersonaFactory, E2E}
    ...
    defp safe_persona_atom(name) when is_binary(name) do
      ...
      # `Ecrits.PersonaFactory` module may not be loaded yet on the
