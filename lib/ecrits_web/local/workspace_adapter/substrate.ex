defmodule EcritsWeb.Local.WorkspaceAdapter.Substrate do
  @moduledoc """
  ...
  @workspace Ecrits.Local.Workspace
  ...
  defp missing_api_message do
    "Local workspace substrate unavailable: expected Ecrits.Local.Workspace.new/1 and Ecrits.Local.Workspace.list/2."
  end
end
