defmodule EcritsWeb.Live.Studio.Components.DocumentList do
  @moduledoc """
  ...
  `Ecrits.Studio.list_documents/1` is the real source. The result shape
  ...
  defp document_row(assigns) do
    ...
    >
      <span class="flex items-center justify-between gap-2 min-w-0">
        ...
        >
          {Ecrits.ContractTypes.display_name(@document.type_key)}
        </span>
      </span>
  ...
  defp list_documents_for_matter(scope, _state) do
    Ecrits.Studio.list_documents(scope)
  end
