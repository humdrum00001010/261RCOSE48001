defmodule EcritsWeb.Live.Studio.Components.ChatCommandButton do
  @moduledoc """
  ...
  Reuse:
    ...
    * The command catalog is sourced from
      `EcritsWeb.Components.CommandPalette.available_commands/1` so the
  ...
  alias EcritsWeb.Components.CommandPalette.Command
