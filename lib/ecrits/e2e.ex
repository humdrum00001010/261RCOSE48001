if Application.compile_env(:ecrits, :test_auth, false) do
  defmodule Ecrits.E2E do
    ...
    scenarios (route gated by `Application.compile_env(:ecrits, :test_auth)`),
    which delegates here.

    The reset is idempotent and removes rows tagged as E2E documents by the
    test DB seeder. Persona users created by `Ecrits.PersonaFactory` are not
