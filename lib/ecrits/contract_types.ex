defmodule Ecrits.ContractTypes do
  @moduledoc """
  ...
  pure-Elixir `:toml` library, and building a `Ecrits.ContractTypes.TypeSpec`
  ...
  alias Ecrits.ContractTypes.DocumentType
  alias Ecrits.ContractTypes.TypeSpec
  alias Ecrits.LegacyRepo, as: Repo

  @types_dir Application.app_dir(:ecrits, "priv/contract_types")
  ...
  """
  @spec list(Ecrits.Types.ctx(), Ecrits.Types.opts()) ::
          Ecrits.Types.result([TypeSpec.t()])
  ...
  """
  @spec get(Ecrits.Types.ctx(), Ecrits.Types.contract_type_key()) ::
          Ecrits.Types.result(TypeSpec.t())
  ...
  """
  @spec get_matching_book(Ecrits.Types.ctx(), Ecrits.Types.contract_type_key()) ::
          {:ok, map()}
  ...
  """
  @spec upsert_matching_book(Ecrits.Types.contract_type_key(), map()) ::
  ...
  """
  @spec ensure_document_type(Ecrits.Types.contract_type_key() | nil) ::
  ...
  @spec document_type_id_for_key(Ecrits.Types.contract_type_key() | nil) ::
  ...
  Reads the current locale from the `EcritsWeb.Gettext` process
  dictionary (set by the `EcritsWeb.Locale` plug / `on_mount` hook).
  ...
  def display_name(nil) do
    case Gettext.get_locale(EcritsWeb.Gettext) do
      "ko" -> "유형 미지정"
      _ -> "Untyped"
    end
  end
