defmodule Ecrits.Agent do
  ...
  lives at `Ecrits.Agent.Document`.
  ...
  @grill_system_prompt """
  당신은 ecrits의 법률 문서 에이전트입니다. 한국어 존댓말로 사용자와 자연스럽게 대화합니다.
  ...
  ecrits-doc MCP tools; the final assistant text is stored as chat only.
  """
