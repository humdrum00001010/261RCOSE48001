defmodule Ecrits.ChangeInput do
  @moduledoc """
  Intermediate result of `Ecrits.Session.Reducer.compile/2`: a validated, ready-to-apply
  representation of an `Ecrits.Command`. Not durable — only `Ecrits.Change`
  is. See SPEC.md §13.
  ...
  Lifecycle:
      ...
      Reducer.build_change/3  → returns Ecrits.Change           (durable)
  """

  alias Ecrits.{MarkInput, Operation, Types}
