defmodule Ecrits.Export.Renderer do
  @moduledoc """
  ...
  def render(%State{} = state, :hwpx, opts) do
    case Ecrits.Export.HWPX.render(state, opts) do
  ...
  def render(%State{} = state, :html, opts) do
    case Ecrits.Export.HTML.render(state, opts) do
  ...
  def render(%State{} = state, :markdown, opts) do
    case Ecrits.Export.Markdown.render(state, opts) do
  ...
  def render(%State{} = state, :lawyer_packet, opts) do
    case Ecrits.Export.LawyerPacket.render(state, opts) do
  ...
  def render(%State{} = state, :pdf, opts) do
    case Ecrits.Export.PDF.render(state, opts) do
  ...
  def render(%State{} = state, :docx, opts) do
    case Ecrits.Export.DOCX.render(state, opts) do
