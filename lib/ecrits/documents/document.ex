defmodule Ecrits.Documents.Document do
  @moduledoc """
  Ecto schema for a Document.

  A Document is the primary user-facing object in ecrits
  ...
  document. `Ecrits.Store.append/3` calls
  `Ecrits.Documents.touch_revision/2` after each commit to keep this
  ...
  schema "documents" do
    ...
    belongs_to :document_type, Ecrits.ContractTypes.DocumentType
