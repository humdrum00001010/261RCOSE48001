defmodule EcritsWeb.Live.Studio.Components.ToastQueueTest do
  ...
  alias EcritsWeb.Live.Studio.Components.ToastQueue

  setup do
    Gettext.put_locale(EcritsWeb.Gettext, "ko")
    on_exit(fn -> Gettext.put_locale(EcritsWeb.Gettext, "en") end)
    :ok
  end
