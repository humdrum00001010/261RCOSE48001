defmodule EcritsWeb.Live.Studio.Components.DocumentListTest do
  ...
  alias EcritsWeb.Live.Studio.Components.DocumentList
  ...
  defp stub_documents(documents) do
    Process.put({Ecrits.LegacyRepo, :stub_return}, documents)
  end
