defmodule Ecrits.Workers.FtcSeedJobIntegrationTest do
  @moduledoc """
  Live end-to-end test for `Ecrits.Workers.FtcSeedJob`. Hits the real
  ...
  `--include live_upstage` tag to run it manually:
      ...
      LIVE_UPSTAGE=1 mix test --include live_upstage \\
        test/ecrits/workers/ftc_seed_job_integration_test.exs
