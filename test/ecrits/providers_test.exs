defmodule Ecrits.ProvidersTest do
  @moduledoc """
  Unit tests for `Ecrits.Providers` (SPEC.md v0.5 §20).
  ...
  describe "render_export/3" do
    test ":lawyer_packet renders a deterministic packet artifact" do
      state = %Ecrits.Runtime.State{
        document_id: "doc-packet",
        revision: 3,
        projection: %{
          Ecrits.Runtime.State.empty_projection()
          | title: "Packet Ecrits",
            nodes: %{
      ...
      assert body =~ "# Lawyer Packet: Packet Ecrits"
