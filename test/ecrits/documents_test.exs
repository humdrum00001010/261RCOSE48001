defmodule Ecrits.DocumentsTest do
  ...
  alias Ecrits.RhwpSnapshot.Record
  ...
  setup do
    ...
    Application.put_env(:ecrits, :io_drivers, Keyword.put(original_drivers, :r2, R2Stub))
  ...
  describe "updates" do
    ...
    test "touch_revision/2 never decreases latest_revision" do
      ...
      assert Ecrits.LegacyRepo.get!(Document, doc.id).latest_revision == 5
