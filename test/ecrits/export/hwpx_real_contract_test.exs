defmodule Ecrits.Export.HWPXRealContractTest do
  @moduledoc """
  Round-trip validation of `Ecrits.Export.HWPX` against a real published
  ...
  1. Load the projection fixture
     ...
     table.
  2. Render via `Ecrits.Export.HWPX.render/2`.
  ...
  `config :ecrits, :hwpx_validator` (see `config/test.exs`).
  """
